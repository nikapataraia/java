public class Poly {
    ...
    public static void main(String[] args) {
        ...
        write("call 1: e2.f(b2, c); ");
        e2.f(b2, c);    // call 1
        write("-------------------------------------");
        write("call 2: g.f(b2, d2);");
        g.f(b2, d2);     // call 2
        write("-------------------------------------");
        write("call 3:  f.f(b2, c2); ");
        f.f(b2, c2);     // call 3
        write("-------------------------------------");
        write("call 4: a.f(c, e);");
        a.f(c, e);      // call 4
        write("-------------------------------------");
        write("call 5: b.f(d, e);");
        b.f(d, e);      // call 5
        write("-------------------------------------");
        write("call 6: c.f(a, e); ");
        c.f(a, e);      // call 6
        write("-------------------------------------");
        write("call 7: e.f(a, d);");
        e.f(a, d);      // call 7
        write("-------------------------------------");
        write("call 8: e.f(b, c); ");
        e.f(b, c);      // call 8
    }
